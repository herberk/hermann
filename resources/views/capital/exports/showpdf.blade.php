...
{{--    Valores INTO--}}
    <tr>
        ...
        <td style="width: 80px"></td>
        <td style="width: 80px;text-align:right">{{number_format($capital->into21,0,'','.')}}</td>
        <td Align="right">=</td>
    </tr>
    @if ($capital->into1<>0)
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->into1,0,'','.')}}</td>
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->into2,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->into3,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
   @if ($capital->into4>0)
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->into4,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    @if ($capital->into5>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->into5,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->into6>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->into6,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->into7>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->into7,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->into8>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->into8,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->into9>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->into9,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
{{--Complementarias--}}
    <tr>
        ...
        <td style="width: 80px"></td>
        <td style="width: 80px;text-align:right">{{ number_format($capital->into22,0,'','.') }}</td>
        <td Align="right">=</td>
    </tr>
    @if ($capital->complementa1>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->complementa1,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->complementa2>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->complementa2,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->complementa3>0)
        <tr>
            ...
            <td style="width: 500px">Otras partidas</td>
            <td style="width: 80px;text-align:right">{{number_format($capital->complementa3,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
{{--Valores financiero y tributarios--}}
    <tr>
        ...
        <td style="width: 80px"></td>
        <td style="width: 80px;text-align:right">{{ number_format($capital->valfinanciero31,0,'','.') }}</td>
        <td Align="right">=</td>
    </tr>
    @if ($capital->valfinanciero1>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero1,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero2>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero2,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero3>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero3,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero4>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero4,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero5>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero5,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero6>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero6,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero7>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero7,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero8>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero8,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    @if ($capital->valfinanciero9>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valfinanciero9,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">-</td>
        </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px"></td>
        <td style="width: 80px;text-align:right">{{ number_format($capital->valtributario32,0,'','.') }}</td>
        <td Align="right">=</td>
    </tr>
    @if ($capital->valtributario1>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario1,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
    @if ($capital->valtributario2>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario2,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
    @if ($capital->valtributario3>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario3,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
    @if ($capital->valtributario4>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario4,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
    @if ($capital->valtributario5>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario5,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
    @if ($capital->valtributario6>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario6,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
    @if ($capital->valtributario7>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario7,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
    @if ($capital->valtributario8>0)
        <tr>
            ...
            <td style="width: 80px;text-align:right">{{number_format($capital->valtributario8,0,'','.')}}</td>
            <td style="width: 80px;text-align:right"></td>
            <td Align="right">+</td>
        </tr>
    @endif
...
{{--    Capital Efectivo--}}
    <tr>
        ...
        <td style="width: 80px;text-align:right"></td>
        <td style="width: 80px;text-align:right"><strong>{{number_format($capital->activo+$capital->into21+$capital->into22+$capital->valfinanciero31+$capital->valtributario32)  ,0,'','.'}}</strong></td>
        <td Align="right">=</td>
    </tr>
...
{{--Pasivo exigible--}}
    <tr>
        ...
        <td style="width: 80px"></td>
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivo51,0,'','.')}}</td>
        <td Align="right">=</td>
    </tr>
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi1,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi2,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi3,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi4,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi5,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi6,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi7,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi8,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi9,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi10,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi11,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
   ...
   <tr>
        ...
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi12,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
    ...
    <tr>
        ...
        <td style="width: 500px">	Otras partidas</td>
        <td style="width: 80px;text-align:right">{{number_format($capital->pasivoexigi13,0,'','.')}}</td>
        <td style="width: 80px;text-align:right"></td>
        <td Align="right">-</td>
    </tr>
    @endif
...
{{-- Capital propio tributario--}}
    <tr>
        ...
        <td style="width: 80px"></td>
        <td style="width: 80px;text-align:right"><strong>{{ number_format($capital->capitaltri,0,'','.') }}</strong></td>
        <td Align="right">=</td>
    </tr>
    <tr>
        <td style="width: 10px">6</td>
