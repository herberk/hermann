    ...
    <td class="text-right">
        <?php if($empresas->trashed()): ?>
            <form action="<?php echo e(route('empresa.destroy', $empresas)); ?>" method="POST">
                ...
                <a href="<?php echo e(route('empresa/restore', $empresas->id)); ?>" class="btn btn-outline-secondary btn-sm"><i class="far fa-window-restore"></i></a>
                <?php echo $__env->renderComponent(); ?>
                <?php $__env->startComponent('shared._tooltip'); ?>
                <?php $__env->slot('mensa', 'Elimina empresa NO habilitado'); ?>
