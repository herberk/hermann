<div class="modal fade" id="createbanco">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="<?php echo e(route('bancosstore')); ?>">
                ...
                <div class="modal-body">
                    <div class="input-group mb-1">
                        ...
                        <?php echo Form::select('empre_id', $emp_com, null, ['class' => 'form-control custom-select py-1']); ?>
                ...
                <div class="modal-footer">
                    <a href="<?php echo e(route("bancosindex")); ?>" class="btn btn-outline-dark btn-sm"><i class="fa fa-undo"></i> Regresar a lista de Bancos</a>
                    <button type="submit" class="btn btn-outline-success btn-sm"><i class="fa fa-save"></i> Guardar </button>
                </div>
            </form>
        </div>
    </div>
</div><?php /**PATH C:\laragon\www\HerBerk\resources\views/empresas/bancos/newbancos.blade.php ENDPATH**/ ?>